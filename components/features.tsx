      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            Líder no Centro-Oeste e uma das maiores marcas de vendas por catálogo do Brasil, em 2021 expandimos para o canal Farma, trazendo ainda mais praticidade e confiança aos consumidores, com foco em produtos desenvolvidos especialmente para farmácias e drogarias de todo o país.
            </p>
          </div>
